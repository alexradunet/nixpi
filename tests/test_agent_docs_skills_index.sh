...
assert_file_contains "$SKILLS_DOC" 'Nixpi Runtime (Hermes)'
...
assert_file_contains "$SKILLS_DOC" '../../infra/pi/skills/nixpi-runtime/SKILL.md'
...
assert_not_contains "$AGENTS_CONTENT" 'infra/pi/skills/nixpi-runtime/SKILL.md'
