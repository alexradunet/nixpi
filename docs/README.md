...
This folder is organized as a modular knowledge base.

## Navigation
- [Operating Model](./runtime/OPERATING_MODEL.md) — multi-agent runtime/evolution workflow
- [Reinstall on Fresh NixOS Minimal (Headless)](./runtime/REINSTALL_MINIMAL_HEADLESS.md) — copy-paste recovery/reinstall checklist
...
- One concept per file keeps docs composable, like code modules.
